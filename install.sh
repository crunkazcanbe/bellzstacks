#!/bin/bash
# ==============================================================================
# 🌸 BELLZSTACKS INSTALLER
# Installs the stacks CLI from github.com/crunkazcanbe/bellzstacks
# Usage: curl -fsSL https://raw.githubusercontent.com/crunkazcanbe/bellzstacks/master/install.sh | bash
# ==============================================================================

REPO="https://raw.githubusercontent.com/crunkazcanbe/bellzstacks/master"
...
echo -e "${RESET}"
echo -e "  ${BOLD}BellzStacks Installer${RESET} — github.com/crunkazcanbe/bellzstacks\n"
...
sed -i "s|/home/bellzserver/MyDocker/Stacks|$STACKS_DIR|g" /tmp/stacks_install
sed -i "s|/home/bellzserver/MyDocker/Configs/Dynamics|$DYNAMICS_DIR|g" /tmp/stacks_install
sed -i "s|loveiznothin\.com|$DOMAIN|g" /tmp/stacks_install
sed -i "s|bellzserver|$SERVER_USER|g" /tmp/stacks_install
sed -i "s|loveiznothin|$USER|g" /tmp/stacks_install
...
for lib in stacks_build.py stacks_fix.py stacks_inject.py stacks_search.py stacks_describe.py stacks_gen_srvs.py stacks_network_guardian.py; do
    ...
    sed -i "s|/home/bellzserver/MyDocker/Stacks|$STACKS_DIR|g" /tmp/$lib
    sed -i "s|loveiznothin|$USER|g" /tmp/$lib
...
# stacks.conf — BellzStacks configuration
