#!/usr/bin/env python3
"""
stacks_fix.py — Automated compose file fixer for BellzServer
...
Config (optional): /home/loveiznothin/.config/stacks/stacks.conf
...
CONF_PATH  = "/home/loveiznothin/.config/stacks/stacks.conf"
BACKUP_DIR = "/home/bellzserver/Documents/BackUPs/Backup"
...
def load_conf():
    cfg = {
        ...
        "FIX_BACKUP": "1",
        "FIX_VOLUME_BASE": "/home/bellzserver/docker",  # base path for bind mounts
...
def net_definition(name, octet, subnet_base):
    ...
    return (
        ...
        f"labels: [\"com.bellzserver.network={base}\", "
        f"\"com.bellzserver.env=production\"], "
...
def ensure_network_in_creator_file(net_name, stacks_dir, subnet_base="10.50"):
    ...
    new_entry = (
        ...
        f"enable_ipv6: false, "
        f"labels: [\"com.bellzserver.network={prefix}\", "
        f"\"com.bellzserver.env=production\"], "
...
def load_global_inject_conf():
    ...
    conf_path = os.path.expanduser("~loveiznothin/.config/stacks/global_inject.conf")
...
def main():
    ...
    vol_base = cfg.get("FIX_VOLUME_BASE", "/home/bellzserver/docker")
